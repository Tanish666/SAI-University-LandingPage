            ...
            <footer className="footer-section">
                <div className="container-fluid px-md-5 px-3">
                    ...
                    <div className="row mt-4 mt-md-5 mb-4 align-items-start">
                        ...
                        {/* Phone */}
                        <div className="col-md-4 col-12 mb-3 mb-md-0 d-flex justify-content-md-center">
                            <div className="mr-3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="mb-0 footer-contact-bold">+91 91500 75661</p>
                        </div>
                        ...
                        <div className="col-md-4 col-12 d-flex justify-content-md-end">
                            ...
                            <p className="mb-0 footer-contact-bold" style={{ wordBreak: 'break-all' }}>admissions@saiuniversity.edu.in</p>
                        </div>
                    </div>
